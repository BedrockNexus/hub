...
import { Appearance } from '@/components/ba-ui/settings/appearance'
import { ThemeToggleItem } from '@/components/ba-ui/settings/theme-toggle-item'
...
export const themePlugin = createAuthPlugin(
	...
	({ useTheme, ...rest }: ThemePluginOptions) => {
		...
		const base = coreThemePlugin({ setTheme: noopSetTheme, ...rest })
		return {
			...base,
